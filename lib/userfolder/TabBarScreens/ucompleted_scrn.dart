...
import 'package:cchurch/Cards/usercards/completedcards.dart';
...
class UCompletedscrn extends StatefulWidget {
  const UCompletedscrn({super.key, required this.pg});
  final String pg;
  @override
  State<UCompletedscrn> createState() => _UCompletedscrnState();
}

class _UCompletedscrnState extends State<UCompletedscrn> {
  @override
  void initState() {
  ...
  pyr_typAsync() async {
    bm = [];
    var tlvStr =
        "select  booktype,prayertype,pr_date,slot,status,b_id from prayer.booking where user_id = '${glb.Uid}'and ch_id = '${glb.church.ch_id}' and status = '1' and payment = '1';";
