...
class UpcomingCrd extends StatefulWidget {
  const UpcomingCrd({super.key, required this.dm});
  final Upcoming_models dm;
  @override
  State<UpcomingCrd> createState() => _UpcomingCrdState();
}

class _UpcomingCrdState extends State<UpcomingCrd> {
  @override
  ...
  stsUpdt_Async() async {
    var tlvStr =
        "update prayer.booking set payment = '1' where b_id = '${glb.booking.bid}';";
