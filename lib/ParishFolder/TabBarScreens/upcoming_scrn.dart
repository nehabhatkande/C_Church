...
import 'package:cchurch/Cards/upcomingcards.dart';
...
class UpComingsrn extends StatefulWidget {
  const UpComingsrn({super.key});

  @override
  State<UpComingsrn> createState() => _UpComingsrnState();
}

class _UpComingsrnState extends State<UpComingsrn> {
  @override
  void initState() {
  ...
  // ============
  List<Upcoming_models> pm = [];
  upcominging_Async() async {
    pm = [];
    var tlvStr =
        " select b_id,user_id,booktype,prayertype,pr_date,slot,status from prayer.booking where ch_id = ${glb.church.ch_id} and status = '1' and payment = '0';";
