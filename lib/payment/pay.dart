...
class Pay_pg extends StatefulWidget {
  const Pay_pg({Key? key}) : super(key: key);

  @override
  State<Pay_pg> createState() => _Pay_pgState();
}

class _Pay_pgState extends State<Pay_pg> {
...
// create order
  ...
  openGateway(String orderId) {
    var options = {
      ...
      'prefill': {
        'contact': '7618735999',
        'email': 'ateequejamadar@gmail.com',
      }
    };
